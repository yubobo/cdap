...
public class HubDataStoreBuilderTest {
  ...
  public void testAddDataSource() {
    ...
    HubDataStore tmpStore = new HubDataStore.Builder().addDataSource(sourceList).build();
    ...
    tmpStore = new HubDataStore.Builder().addDataSource(sourceList).build();
  ...
  public void testAddDataSink() {
    ...
    HubDataStore tmpStore = new HubDataStore.Builder().addDataSink(sinkList).build();
    ...
    tmpStore = new HubDataStore.Builder().addDataSink(sinkList).build();
