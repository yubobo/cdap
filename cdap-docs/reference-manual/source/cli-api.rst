...
.. csv-table::
   ...
   **Preferences**
   ``get instance preferences``, "Get Preferences of CDAP Instance."
   ``get namespace preferences``, "Get Preferences of the Namespace."
   ``get app preferences <app-id>``, "Get Preferences of a Application."
   ``get flow preferences <app-id.flow-id>``, "Get Preferences of a Flow."
   ``get namespace resolved preferences``, "Get Resolved Preferences of the Namespace."
   ``get app resolved preferences <app-id>``, "Get Resolved Preferences of a Application."
   ``get flow resolved preferences <app-id.flow-id>``, "Get Resolved Preferences of a Flow."
   ``set instance preferences <arguments>``, "Set Preferences of CDAP Instance. <arguments> is specified in the format ""key1=a, key2=b"".""
   ``set namespace preferences <arguments>``, "Set Preferences of the Namespace. <arguments> is specified in the format ""key1=a, key2=b"".""
   ``set app preferences <arguments> <app-id>``, "Set Preferences of a Application. <arguments> is specified in the format ""key1=a, key2=b"".""
   ``set flow preferences <arguments> <app-id.flow-id>``, "Set Preferences of a Flow. <arguments> is specified in the format ""key1=a, key2=b""."""
   ``delete instance preferences``, "Delete Preferences of CDAP Instance."
   ``delete namespace preferences``, "Delete Preferences of the Namespace."
   ``delete app preferences <app-id>``, "Delete Preferences of a Application."
   ``delete flow preferences <app-id.flow-id>``, "Delete Preferences of a Flow."
