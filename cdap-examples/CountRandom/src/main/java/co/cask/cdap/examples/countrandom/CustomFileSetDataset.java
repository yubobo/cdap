 ...
 */
public final class CustomFileSetDataset implements FileSet {
   ...
   */
  public CustomFileSetDataset(DatasetContext datasetContext, DatasetSpecification spec,
    ...
    this.baseLocation = new LocalLocationFactory().create(determineBasePath(spec));
