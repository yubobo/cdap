 ...
 *
 */
public class ReactorDatasetClientTest extends ReactorClientTestBase {

  private static final Logger LOG = LoggerFactory.getLogger(ReactorDatasetClientTest.class);

  private ReactorDatasetClient datasetClient;
  ...
  public void setUp() throws Throwable {
    ...
    datasetClient = new ReactorDatasetClient(config);
