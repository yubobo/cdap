 ...
 *
 */
public class ReactorStreamClientTest extends ReactorClientTestBase {

  private static final Logger LOG = LoggerFactory.getLogger(ReactorStreamClientTest.class);

  private ReactorStreamClient streamClient;
  ...
  public void setUp() throws Throwable {
    ...
    streamClient = new ReactorStreamClient(config);
  }
