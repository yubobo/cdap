...
import com.continuuity.reactor.client.exception.AlreadyExistsException;
import com.continuuity.reactor.client.exception.BadRequestException;
import com.continuuity.reactor.client.exception.DatasetModuleAlreadyExistsException;
import com.continuuity.reactor.client.exception.DatasetModuleCannotBeDeletedException;
import com.continuuity.reactor.client.exception.DatasetModuleNotFoundException;
 ...
 */
public class ReactorDatasetModuleClient {

  private final RestClient restClient;
  private final ReactorClientConfig config;

  @Inject
  public ReactorDatasetModuleClient(ReactorClientConfig config) {
    this.config = config;
