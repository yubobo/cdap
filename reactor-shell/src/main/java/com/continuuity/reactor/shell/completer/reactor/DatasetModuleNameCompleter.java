...
public class DatasetModuleNameCompleter extends StringsCompleter {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(DatasetModuleNameCompleter.class);
...
//          LOG.error("Error retrieving dataset module name list for autocompletion", e);
          return Lists.newArrayList();
        }
      }
    });
