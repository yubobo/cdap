...
public interface DatasetFramework {
   ...
   * method to build {@link com.continuuity.reactor.metadata.DatasetSpecification} which describes dataset instance
  ...
  /**
   * @return a collection of {@link com.continuuity.reactor.metadata.DatasetSpecification}s for all datasets
   */
