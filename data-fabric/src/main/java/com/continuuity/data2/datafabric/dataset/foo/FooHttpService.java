 ...
 *
 */
public class FooHttpService extends AbstractIdleService {

  private static final Logger LOG = LoggerFactory.getLogger(FooHttpService.class);
  ...
  @Inject
  public FooHttpService(CConfiguration cConf,
    ...
    builder.addHttpHandlers(ImmutableList.of(new FooHttpHandler()));
  ...
  protected void startUp() throws Exception {
    LOG.info("Starting FooHttpService");
    ...
    LOG.info("FooHttpService started successfully on {}", httpService.getBindAddress());
  }

  @Override
  protected void shutDown() throws Exception {
    LOG.info("Stopping FooHttpService");
