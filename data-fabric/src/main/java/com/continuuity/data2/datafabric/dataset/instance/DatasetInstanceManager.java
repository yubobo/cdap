...
public class DatasetInstanceManager {
   ...
   * @param spec {@link com.continuuity.reactor.metadata.DatasetSpecification} of the dataset instance to be added
   */
   ...
   * @return dataset instance's {@link com.continuuity.reactor.metadata.DatasetSpecification}
   */
  ...
  /**
   * @return collection of {@link com.continuuity.reactor.metadata.DatasetSpecification} of all dataset instances
   */
