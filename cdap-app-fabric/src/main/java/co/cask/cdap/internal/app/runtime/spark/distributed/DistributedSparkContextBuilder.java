...
package co.cask.cdap.internal.app.runtime.spark.distributed;
 ...
 */
public class DistributedSparkContextBuilder extends AbstractSparkContextBuilder {
  private final CConfiguration cConf;
  private final Configuration hConf;
  private ZKClientService zkClientService;

  public DistributedSparkContextBuilder(CConfiguration cConf, Configuration hConf) {
    this.cConf = cConf;
    this.hConf = hConf;
  }
