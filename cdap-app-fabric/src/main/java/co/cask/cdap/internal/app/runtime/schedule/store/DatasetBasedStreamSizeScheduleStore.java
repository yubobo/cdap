...
public class DatasetBasedStreamSizeScheduleStore {
  ...
  public void persistStreamSizeSchedule(Id.Program programId, SchedulableProgramType programType,
                                        ...
                                        boolean running) {
    byte[][] columns = new byte[][] { SCHEDULE_COL, BASE_SIZE_COL, BASE_TS_COL, ACTIVE_COL };
   ...
   * @param scheduleName name of the schedule
   */
  public void deleteStreamSizeSchedule(final Id.Program programId, final SchedulableProgramType programType,
        ...
        .execute(new TransactionExecutor.Subroutine() {
          ...
          public void apply() throws Exception {
            ...
            while ((next = scan.next()) != null) {
              ...
              if (scheduleBytes == null || baseSizeBytes == null || baseTsBytes == null || activeBytes == null) {
                continue;
              }
              ...
              StreamSizeScheduleState scheduleState =
                new StreamSizeScheduleState(program, programType, schedule, baseSize, baseTs, active);
  ...
  public static class StreamSizeScheduleState {
    ...
    StreamSizeScheduleState(Id.Program programId, SchedulableProgramType programType,
                            StreamSizeSchedule streamSizeSchedule, long baseRunSize, long baseRunTs, boolean running) {
    ...
    @Override
    public int hashCode() {
      return Objects.hashCode(programId, programType, streamSizeSchedule, baseRunSize, baseRunTs, running);
    }
  }
