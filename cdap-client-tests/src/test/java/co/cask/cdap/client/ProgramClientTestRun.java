...
public class ProgramClientTestRun extends ClientTestBase {
  ...
  private void testWorkflowCommand(Id.Program workflow) throws Exception {
    ...
    List<WorkflowActionNode> nodes = programClient.getWorkflowCurrent(workflow.getApplication(), workflow.getId(),
