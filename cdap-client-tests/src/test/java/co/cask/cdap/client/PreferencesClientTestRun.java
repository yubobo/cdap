...
public class PreferencesClientTestRun extends ClientTestBase {
  ...
  public void testPreferences() throws Exception {
    ...
    namespaceClient.createNamespace(new NamespaceMeta.Builder().setName(invalidNamespace.getId()).build());
    ...
    try {
      ...
      appClient.delete(FAKE_APP_ID.getId());
      namespaceClient.deleteNamespace(invalidNamespace);
    }
  }
  ...
  public void testDeletingNamespace() throws Exception {
    ...
    namespaceClient.createNamespace(new NamespaceMeta.Builder().setName(myspace.getId()).build());
    ...
    namespaceClient.deleteNamespace(myspace);
    namespaceClient.createNamespace(new NamespaceMeta.Builder().setName(myspace.getId()).build());
