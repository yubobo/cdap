...
define(function() {
  ...
  var Directive = [function() {
    ...
    function displayGraphExample (elm, width, height, interpolation, animate, updateDelay, transitionDelay) {
      // create an SVG element inside the #graph div that fills 100% of the div
      var graph = d3.select(elm).append("svg:svg").attr("width", "100%").attr("height", "100%");
