...
define(['helpers'], function (helpers) {
  ...
  function ___fixStreams () {
    ...
    var flowlets = this.get('controller').elements.Flowlet;
    var fs = this.flow.flowletStreams;
  ...
  var visualizer = {
    ...
    didInsertElement: function () {
      ...
      if (this.flow.hasOwnProperty('flowStreams') && this.flow.flowStreams.length) {
        var source;
        var fs = this.flow.flowStreams;
