...
public class CountRandom_07_FlowletsSplitterTests extends GenericTest {
  static AppPage app;
  ...
  public void test_03_H1Text() {
    ...
    String strToMatch = Global.properties.getProperty("splitterH1");
  ...
  @Test
  public void test_28_OutboundTitle() {
    assumeTrue(page.isTableProcessedPresent());
  ...
  @Test
  public void test_29_OutboundValue() {
    assumeTrue(page.isTableProcessedPresent());
