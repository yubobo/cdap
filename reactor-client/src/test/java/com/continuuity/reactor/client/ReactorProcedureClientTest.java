 ...
 *
 */
public class ReactorProcedureClientTest extends ReactorClientTestBase {

  private static final Logger LOG = LoggerFactory.getLogger(ReactorProcedureClientTest.class);
