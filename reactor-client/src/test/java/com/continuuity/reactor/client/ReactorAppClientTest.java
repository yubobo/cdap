 ...
 *
 */
public class ReactorAppClientTest extends ReactorClientTestBase {

  private static final Logger LOG = LoggerFactory.getLogger(ReactorAppClientTest.class);
  ...
  public void setUp() throws Throwable {
    ...
    appClient = new ReactorAppClient(new ReactorClientConfig("localhost"));
  }
